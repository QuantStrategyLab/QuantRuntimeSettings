...
def build_config_module(config: dict) -> str:
    ...
    platform_meta = {
        pid: {
            ...
            "code": pdata.get("code", pid.upper()),
            "accent": pdata.get("accent_color", "var(--accent)"),
        }
        for pid, pdata in platforms.items()
    }
    ...
    lines = [
        ...
        "",
        f"export const PLATFORM_META = {json.dumps(platform_meta, indent=2, ensure_ascii=False)};",
        "",
