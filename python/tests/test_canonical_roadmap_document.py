...
class CanonicalRoadmapDocumentTest(unittest.TestCase):
    def test_canonical_document_preserves_required_governance_boundaries(self):
        ...
        for required_text in (
            ...
            "soxl_soxx_core_only_p2_v2",
            "SOXL/SOXX 已有纯三资产 P1 数据身份契约",
            "SOXL 已有独立、状态化 P3 replay 基础能力",
            "P1 bars→context materializer、固定三折/252-session OOS/5-10-15 bps evidence plan、指标/哈希摘要和本地离线总入口",
            "MIGRATION_REQUIRED",
