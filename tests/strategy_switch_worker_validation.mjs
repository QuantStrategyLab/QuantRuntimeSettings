...
assert.ok(indexHtml.includes('!supportedModes.includes(button.dataset.mode)'));
...
assert.ok(indexHtml.includes('dryRun: "只计算信号"'));
assert.ok(indexHtml.includes('dryRun: "Calculate signals only"'));
